    ...
    try {
        ...
        data.slice(0, 9).forEach((items) => {
            ...
            <div class="card">
                ...
                <button class="btn btn-warning " onclick='single_prouct(${items.id})'>View</button>
                <button class="btn btn-success" onclick='addtocart(${items.id})'>Add to Cart</button>
                </div>
            </div>
       </div>`
        });
        ...
        data.forEach((items) => {
            row += `<div class='col-md-4'>
             <div class="card">
                 ...
                 <h4 class="card-title">${items.category}</h4>
                 <p class="card-text">Price :$ ${items.price}</p>
                 <button class="btn btn-warning " onclick='single_product( ${items.id})'>View</button>
                 <a href="#" class="btn btn-success">Add to Cart</a>
                 </div>
             </div>
        </div>`
